...
def _get_grid_locations(image_height, image_width):
  ...
  y_range = tf.linspace(tf.convert_to_tensor(0.), tf.cast(image_height - 1, tf.float32), image_height)
  x_range = tf.linspace(tf.convert_to_tensor(0.), tf.cast(image_width - 1, tf.float32), image_width)
